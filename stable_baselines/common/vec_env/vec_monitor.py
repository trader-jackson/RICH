...
from stable_baselines.common.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        from stable_baselines.common.monitor import Monitor, ResultsWriter
